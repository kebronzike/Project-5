...
public class StateTest extends student.TestCase {
    ...
    public void testtoString() {
        assertEquals(test1.toString(),
            "black: 2 cases, 7 deaths, 300.0% CFR\r\n"
                + "asian: 4 cases, 4 deaths, 100.0% CFR\r\n"
                + "white: 6 cases, 5 deaths, 0.0% CFR\r\n"
                + "latinx: 2 cases, 8 deaths, 400.0% CFR\r\n"
                + "other: 10 cases, 100 deaths, 1000.0% CFR\r\n" + "");
    }
